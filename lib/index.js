                ...
                wctx.webServer.register({
                    ...
                    handler: async (req, res) => {
                        ...
                        if (req.method === "GET") {
                            try {
                                const u = new URL(req.url || "", "http://localhost");
                                const value = { sources: listImportSources(home) };
                        ...
                        try {
                            ...
                            let result;
                            if (action === "add")
                                result = addImportSource(home, body);
                            else if (action === "remove")
                                result = removeImportSource(home, id);
                            else if (action === "resync")
                                result = resyncImportSource(home, id);
                            else if (action === "update")
                                result = updateImportSource(home, id, body);
                            else {
